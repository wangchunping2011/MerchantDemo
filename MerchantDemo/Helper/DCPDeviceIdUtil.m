...
#define KEY_UUID_INSTEAD [[NSBundle mainBundle] bundleIdentifier]

@implementation DCPDeviceIdUtil

+ (NSString *)getDeviceIDInKeychain
{
    NSString *getUDIDInKeychain = (NSString *)[DCPDeviceIdUtil load:KEY_UUID_INSTEAD];
    if (!getUDIDInKeychain || [getUDIDInKeychain isEqualToString:@""] || [getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [DCPDeviceIdUtil save:KEY_UUID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[DCPDeviceIdUtil load:KEY_UUID_INSTEAD];
    }
