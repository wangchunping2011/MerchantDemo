...
+ (SecKeyRef)publicKeyFromPemWithNoHeaderAndFooter:(NSString *)publicKey ifError:(NSError **)error
{
    ...
    NSData* keyData = [self dataTrimFromPublicPemWithNoHeaderAndFooter:publicKey];
    if(keyData!=nil)
    {
        return [self publicKeyFromData:keyData andTag:@"vkrsa.publickey" error:error];
    }else{
...
+ (NSData*) dataTrimFromPublicPemWithNoHeaderAndFooter:(NSString*)key
{
    key = [key stringByReplacingOccurrencesOfString:@"\r" withString:@""];
    key = [key stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    key = [key stringByReplacingOccurrencesOfString:@"\t" withString:@""];
...
+ (NSData*) dataTrimFromPrivatePemNoHeaderAndFooter:(NSString*)key
{
    key = [key stringByReplacingOccurrencesOfString:@"\r" withString:@""];
    key = [key stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    key = [key stringByReplacingOccurrencesOfString:@"\t" withString:@""];
